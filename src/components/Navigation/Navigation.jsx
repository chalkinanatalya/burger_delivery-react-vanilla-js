    ...
    return (
        ...
        <Container className={style.container}>
          <ul className={style.list}>
            ...
            <li className={style.item}>
              <button className={classNames(style.button, style.button_burger, style.button_dessert)}>Десерты</button>
            </li>
            <li className={style.item}>
              <button className={classNames(style.button, style.button_burger, style.button_sauce)}>Соусы</button>
            </li>
          </ul>
        </Container>
      </nav>
